...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Vivek Sahu");
		alert.setContentText("I love to play around with code and create games."+
				             " Connect four is one of the best games.In free times "+
				             " I like to spend free times with nears and dears.");
		alert.show();
	...
	private void aboutConnect4() {
		...
		alert.setContentText("Connect Four is a two-player connection game in which the players " +
				             ...
				             " one's own discs. Connect Four is a solved game.The first player  " +
